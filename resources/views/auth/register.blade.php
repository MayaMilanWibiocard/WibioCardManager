<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Secret code -->
        <div class="mt-4">
            <x-input-label for="scode" :value="__('Secret code')" />
            <x-text-input id="scode" class="block mt-1 w-full" type="password" name="scode" :value="old('scode')" />
            <x-input-error :messages="$errors->get('scode')" class="mt-2" />
        </div>
